  ...
  return (
    <div className="visuals-display">
      <div className="left-visual">
        ...
        eligendi blanditiis odio quae nostrum, ex corrupti architecto quam
        provident esse. Porro cupiditate accusantium, mollitia totam magni rerum
        fuga hic.
      </div>
      <div className="right-visual">
        ...
        <div className="right-chart">CHART WILL GO HERE</div>
      </div>
    </div>
  );
};
