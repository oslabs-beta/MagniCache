  ...
  return (
    <div id="about-page">
      ...
      <p className="install-steps">
        ...
        <code>npm i @magnicache/server</code>
      </p>
      <p className="install-steps">
        2. Import MagniCache <br />
        <code>const MagniCache = require('@magnicache/server');</code>
      </p>
      <p className="install-steps">
        3. Declare a new instance of MagniCache, passing in your GraphQL schema
        <br />
        <code>const magnicache = new MagniCache(schema);</code>
      </p>
      <p className="install-steps">
        ...
        <br />
        <code>
          app.use('/graphql', magnicache.query, (req, res) ={'>'} {'{'} <br />
          {'return'} {'res'}.status(200).send(res.locals.queryResponse); <br />
          {'}'}
          );
        </code>
      </p>
